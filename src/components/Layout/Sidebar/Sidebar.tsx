    ...
    menuItems: [
      {
        ...
        route: '',
        children: [
          { label: 'Button', route: '/example/button' },
          { label: 'UI', route: '/example/ui' },
          { label: 'Feedback', route: '/example/feedback' },
          { label: 'Form', route: '/example/form' },
          { label: 'Table', route: '/example/table' },
        ],
      },
    ],
  },
    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <Link href="/">
            <Image src="/logo-sidebar.png" alt="로고 이미지" width={176} height={32} unoptimized></Image>
          </Link>
